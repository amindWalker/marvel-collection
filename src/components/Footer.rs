...
pub fn Footer() -> Element {
    rsx! {
        div {
            class: "absolute bottom-10 grid grid-cols-3 lg:grid-cols-6 w-full place-items-center",
            footer {
                class: "base-container col-start-1 lg:col-start-2 col-end-4 lg:col-end-6 auto-cols-fr auto-rows-min w-full grid",
                div {
                    class: "text-center",
                    a {
                        class: "text-white/30 hover:text-red-700",
                        href: "https://marvel.com",
                        "Data provided by Marvel. © 2025 MARVEL"
                    }
                    p { class: "text-white/30", "Made in Full Rust Stack" }
                    a {
                        class: "text-white/30 hover:text-red-700",
                    ...
                    div {
                        class: "grid grid-flow-col place-content-center m4 gap4 text-xl",
